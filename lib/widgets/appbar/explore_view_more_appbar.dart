...
class ExploreViewMoreAppBar extends StatefulWidget {
  final Function() onTap;

  const ExploreViewMoreAppBar({Key? key, required this.onTap}) : super(key: key);

  @override
  State<ExploreViewMoreAppBar> createState() => _ExploreViewMoreAppBarState();
}

class _ExploreViewMoreAppBarState extends State<ExploreViewMoreAppBar> {
  String search = '';
  ...
  TextFormField buildSearchFormField() {
    return TextFormField(
      ...
      onTap: () => {
        ...
        Navigator.pushNamed(context, ExploreSearch.routeName, arguments: {
          'title': 'جستجو'
        })
      },
