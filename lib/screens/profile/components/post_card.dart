...
Widget PostCard(Post post, BuildContext context) {
  return InkWell(
...
Widget post_options(BuildContext context) => SingleChildScrollView(
  child: Column(
    children: [
      BottomModalOption(
          label: 'فعال / غیر فعال کردن پست',
          onTap: () => {
      ...
      BottomModalOption(
        label: 'افزودن / ویرایش مدیا',
        onTap: () => {
          Navigator.pop(context),
          Navigator.pushNamed(context, PostMediaScreen.routeName, arguments: {
            'title' : 'مدیای پست'
          })
        },
      ),
