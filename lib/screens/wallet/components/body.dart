...
import 'wallet_money_request.dart';
import 'wallet_turnover.dart';
...
class _BodyState extends State<Body> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    final totalMoney = 150000;
    final blockedMoney = 75000;
    final availableMoney = 75000;
